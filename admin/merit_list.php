...
<div class="col-sm-8">
<form name="m1" id="m1" method="post" action="dashboard.php?a=5">
...
if($caste=='General')
{
$s="select * from apply where course_id='$course_id' and hslc_per>='$cut_off' order by hslc_per desc limit $total";	
}
else
{
...
else
{
	if($caste=='General')
	{
			$s="select * from apply where course_id='$course_id' and hs_per>='$cut_off' order by hs_per desc limit $total";
}
	else
	{	
